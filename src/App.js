  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex ${isMe ? "justify-end" : "justify-start"} gap-2 relative group mb-4`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `flex flex-col ${isMe ? "items-end" : "items-start"} max-w-[75%]`, children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsxs("div", { onClick: handleBubbleClick, className: `p-2 px-3 rounded-2xl text-[13px] shadow-sm relative cursor-pointer ${m.type === "sticker" ? "bg-transparent shadow-none p-0" : isMe ? "bg-[#7cfc00] rounded-tr-none" : "bg-white rounded-tl-none"} ${["image", "video", "call_invite"].includes(m.type) ? "p-0 bg-transparent shadow-none" : ""}`, children: [
        ...
        /* @__PURE__ */ jsx("div", { className: `text-[8px] opacity-50 mt-1 text-right ${m.type === "sticker" ? "text-gray-500 font-bold bg-white/50 px-1 rounded" : ""}`, children: formatDateTime(m.createdAt) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-3 bg-white border-t flex flex-col gap-2 relative z-10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        (text || isUploading) && /* @__PURE__ */ jsx("button", { onClick: () => sendMessage(text), disabled: !text && !isUploading, className: `p-2 rounded-full ${text ? "text-green-500" : "text-gray-300"}`, children: isUploading ? /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsx(Loader2, { className: "w-6 h-6 animate-spin text-green-500" }),
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto scrollbar-hide", children: [
          /* @__PURE__ */ jsxs("div", { className: "px-5 py-6 flex items-center gap-4 hover:bg-white/70 cursor-pointer border-b border-[#d5d9e0]", onClick: () => setView("profile"), children: [
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx("img", { src: profile?.avatar, className: "w-16 h-16 rounded-2xl object-cover border border-gray-300" }, profile?.avatar),
              isTodayBirthday(profile?.birthday) && /* @__PURE__ */ jsx("span", { className: "absolute -top-1 -right-1 text-base", children: "\u{1F382}" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsx("div", { className: "font-black text-4xl text-black leading-none", children: profile?.name }),
              /* @__PURE__ */ jsxs("div", { className: "text-[14px] text-[#8b95a5] font-mono mt-2", children: [
                "ID: ",
                profile?.id
              ] })
            ] })
          ...
          tab === "chats" && /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            chats.filter((chat) => !profile?.hiddenChats?.includes(chat.id)).sort((a, b) => (b.updatedAt?.seconds || 0) - (a.updatedAt?.seconds || 0)).map((chat) => {
              ...
              return /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "px-5 py-4 flex items-center gap-4 hover:bg-white/60 cursor-pointer relative group border-b border-[#d5d9e0]",
                  onClick: () => {
...
function App() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full min-h-[100dvh] bg-[#f3f4f6] flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "w-full h-[100dvh] bg-[#f3f4f6] flex flex-col relative overflow-hidden", children: [
    ...
    !user ? /* @__PURE__ */ jsx(AuthView, { onLogin: setUser, showNotification }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      user && !activeCall && ["home", "voom"].includes(view) && /* @__PURE__ */ jsxs("div", { className: "h-24 bg-[#f3f4f6] border-t border-gray-300 flex items-center justify-around z-50 pb-4 shrink-0", children: [
        /* @__PURE__ */ jsxs("div", { className: `flex flex-col items-center gap-1 cursor-pointer transition-all ${view === "home" ? "text-green-500" : "text-[#9aa3b3]"}`, onClick: () => setView("home"), children: [
          /* @__PURE__ */ jsx(Home, { className: "w-7 h-7" }),
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold", children: "\u30DB\u30FC\u30E0" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: `flex flex-col items-center gap-1 cursor-pointer transition-all ${view === "voom" ? "text-green-500" : "text-[#9aa3b3]"}`, onClick: () => setView("voom"), children: [
          /* @__PURE__ */ jsx(LayoutGrid, { className: "w-7 h-7" }),
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold", children: "VOOM" })
        ] })
      ] })
    ] }),
...
const HomeView = ({ user, profile, allUsers, chats, setView, setActiveChatId, setSearchModalOpen, startChatWithUser, showNotification }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "px-5 py-4 border-b border-gray-300 flex justify-between items-center bg-[#f3f4f6] shrink-0", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-[44px] leading-none font-black tracking-tight", children: "\u30DB\u30FC\u30E0" }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-5 items-center", children: [
            /* @__PURE__ */ jsx(Store, { className: "w-6 h-6 cursor-pointer text-orange-500", onClick: () => setView("sticker-store") }),
            /* @__PURE__ */ jsx(Gift, { className: "w-6 h-6 cursor-pointer text-pink-500", onClick: () => setView("birthday-cards") }),
            /* @__PURE__ */ jsx(Users, { className: "w-6 h-6 cursor-pointer text-black", onClick: () => setView("group-create") }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex border-b border-gray-300 bg-[#f3f4f6]", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              className: `flex-1 py-4 text-xl font-bold ${tab === "friends" ? "border-b-[3px] border-black text-black" : "text-[#8b95a5]"}`,
              onClick: () => setTab("friends"),
              children: "\u53CB\u3060\u3061"
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
            {
              className: `flex-1 py-4 text-xl font-bold ${tab === "hidden" ? "border-b-[3px] border-black text-black" : "text-[#8b95a5]"}`,
              onClick: () => setTab("hidden"),
              children: "\u975E\u8868\u793A"
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
            {
              className: `flex-1 py-4 text-xl font-bold ${tab === "chats" ? "border-b-[3px] border-black text-black" : "text-[#8b95a5]"}`,
              onClick: () => setTab("chats"),
              children: "\u30C8\u30FC\u30AF"
            }
          )
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto scrollbar-hide", children: [
          /* @__PURE__ */ jsxs("div", { className: "px-5 py-6 flex items-center gap-4 hover:bg-white/70 cursor-pointer border-b border-gray-300", onClick: () => setView("profile"), children: [
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx("img", { src: profile?.avatar, className: "w-16 h-16 rounded-2xl object-cover border border-gray-300" }, profile?.avatar),
              isTodayBirthday(profile?.birthday) && /* @__PURE__ */ jsx("span", { className: "absolute -top-1 -right-1 text-base", children: "\u{1F382}" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsx("div", { className: "font-black text-3xl text-black", children: profile?.name }),
              /* @__PURE__ */ jsxs("div", { className: "text-base text-[#8b95a5] font-mono mt-1", children: [
                "ID: ",
                profile?.id
              ] })
            ] })
          ...
          tab === "chats" && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("div", { className: "px-5 pt-5", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-[#eef1f5] border border-gray-300 rounded-[28px] px-5 py-4 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold text-[#8b95a5] uppercase tracking-widest", children: "\u30C8\u30FC\u30AF\u53CB\u3060\u3061" }),
                  /* @__PURE__ */ jsx("div", { className: "text-xs text-[#677184] font-bold mt-1", children: "1\u5BFE1\u30C8\u30FC\u30AF\u306E\u4EBA\u6570" })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "text-4xl font-black text-[#1c2433]", children: talkFriendCount })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "bg-[#eef1f5] border border-gray-300 rounded-[28px] px-5 py-4 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold text-[#8b95a5] uppercase tracking-widest", children: "\u30B0\u30EB\u30FC\u30D7" }),
                  /* @__PURE__ */ jsx("div", { className: "text-xs text-[#677184] font-bold mt-1", children: "\u53C2\u52A0\u4E2D\u306E\u6570" })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "text-4xl font-black text-[#1c2433]", children: groupChatCount })
              ] })
            ] }) }),
            chats.filter((chat) => !profile?.hiddenChats?.includes(chat.id)).sort((a, b) => (b.updatedAt?.seconds || 0) - (a.updatedAt?.seconds || 0)).map((chat) => {
              let name = chat.name, icon = chat.icon, partnerData = null;
              ...
              return /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "px-5 py-4 flex items-center gap-4 hover:bg-white/60 cursor-pointer relative group border-b border-gray-200",
                  onClick: () => {
                    setActiveChatId(chat.id);
                    setView("chatroom");
                  },
...
function App() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full min-h-[100dvh] bg-slate-200 md:p-6 flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "w-full h-[100dvh] bg-white flex flex-col relative overflow-hidden md:max-w-[430px] md:h-[95dvh] md:max-h-[900px] md:rounded-[36px] md:border md:border-black/10 md:shadow-2xl", children: [
    notification && /* @__PURE__ */ jsx("div", { className: "fixed top-10 left-1/2 -translate-x-1/2 z-[300] bg-black/85 text-white px-6 py-2 rounded-full text-xs font-bold shadow-2xl animate-bounce", children: notification }),
    !user ? /* @__PURE__ */ jsx(AuthView, { onLogin: setUser, showNotification }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      activeCall ? effectiveCallPhase === "incoming" ? /* @__PURE__ */ jsx(
        IncomingCallOverlay,
